...
Options:
    ...
    -C <maxContacts> maximum contacts [default: 50000]
...
def print_contact(features1, extra1, features2=None, extra2=None, minD=0, maxD=1e8, maxContacts=50000):
    logging.debug('start')
    ...
    if maxContacts == None:
        ...
        if temp > maxContacts: 
            ...
            index  = np.sort(np.random.choice(temp - 1, maxContacts, replace=False))
            output = output[index]
            for i in output: 
                print(i)
        else:
...
def main(args):
    ...
    if args['domain']:
        ...
        print_contact(features1, extra1, features2=features2, extra2=extra2, minD=minD, maxD=maxD, maxContacts=maxContacts)
